...
function twi() {
    ...
    if (dateLower && dateUpper) {
        //work out date stuff
    document.getElementById("twi_link").href = 'https://twitter.com/search?lang=en-GB&q=' + twi_string.replace(' ', '%20') + 'until%3A' + dateUpper + '-12-31%20since%3A' + dateLower + '-01-01&src=typed_query';
    } else {
...
function gale() {
    ...
    // update link out
    if (dateLower && dateUpper) {
    document.getElementById("gale_link").href = 'https://go.gale.com/ps/advancedSearch.do?operators%5B999%5D=And&inputFieldValues%5B999%5D=&inputFieldNames%5B999%5D=OQE&fuzzyLevels%5BOQE%5D=HIGH&fuzzyLevels%5BTXT%5D=HIGH&inputFieldValues%5B0%5D=' + gale_string.replace(' ', '+') + '&inputFieldNames%5B0%5D=TXT&operators%5B1%5D=And&inputFieldValues%5B1%5D=&inputFieldNames%5B1%5D=TXT&operators%5B2%5D=And&inputFieldValues%5B2%5D=&inputFieldNames%5B2%5D=OQE&_fuzzyEnabled=on&limiterFieldValues%5BDB%5D=GDSC&limiterFieldValues%5BDB%5D=BNCN&limiterFieldValues%5BDB%5D=DMHA&limiterFieldValues%5BDB%5D=ECCO&limiterFieldValues%5BDB%5D=FTHA&limiterFieldValues%5BDB%5D=NCCO&limiterFieldValues%5BDB%5D=NCNP&limiterFieldValues%5BDB%5D=NCUK&limiterFieldValues%5BDB%5D=PLEX&limiterFieldValues%5BDB%5D=BBCN&limiterFieldValues%5BDB%5D=NICN&limiterFieldValues%5BDB%5D=ECON&limiterFieldValues%5BDB%5D=ILN&limiterFieldValues%5BDB%5D=MOML&limiterFieldValues%5BDB%5D=MOME&limiterFieldValues%5BDB%5D=STHA&limiterFieldValues%5BDB%5D=TGRH&limiterFieldValues%5BDB%5D=TTDA&limiterFieldValues%5BDB%5D=TLSH&limiterFieldValues%5BDB%5D=USDD&limiterTypes%5BDB%5D=OR&dateIndices=DA&dateLimiterValues%5BDA%5D.dateMode=4&dateLimiterValues%5BDA%5D.fromDay=00&dateLimiterValues%5BDA%5D.fromMonth=00&dateLimiterValues%5BDA%5D.fromYear=' + dateLower + '&dateLimiterValues%5BDA%5D.toDay=00&dateLimiterValues%5BDA%5D.toMonth=00&dateLimiterValues%5BDA%5D.toYear=' + dateUpper + '&standAloneLimiters=DA&_nonDatedLimiterValues%5BDA%5D=on&standAloneLimiters=DG&limiterTypes%5BDG%5D=OR&standAloneLimiters=TY&limiterTypes%5BTY%5D=OR&limiterFieldValues%5BPU%5D=&standAloneLimiters=PU&standAloneLimiters=GS&limiterTypes%5BGS%5D=OR&standAloneLimiters=PUB_COUNTRY&limiterTypes%5BPUB_COUNTRY%5D=OR&standAloneLimiters=PUB_STATE_COUNTRY&limiterTypes%5BPUB_STATE_COUNTRY%5D=OR&standAloneLimiters=PUB_CITY_STATE_COUNTRY&limiterTypes%5BPUB_CITY_STATE_COUNTRY%5D=OR&standAloneLimiters=LG&limiterTypes%5BLG%5D=OR&standAloneLimiters=IMG_TY&limiterTypes%5BIMG_TY%5D=OR&standAloneLimiters=SRC_INST&limiterTypes%5BSRC_INST%5D=OR&method=doSearch&noOfRows=3&searchType=AdvancedSearchForm&userGroupName=oxford&prodId=GDCS&nwf=y&searchResultsType=MultiTab';
} else {
        document.getElementById("gale_link").href = 'https://go.gale.com/ps/advancedSearch.do?operators%5B999%5D=And&inputFieldValues%5B999%5D=&inputFieldNames%5B999%5D=OQE&fuzzyLevels%5BOQE%5D=HIGH&fuzzyLevels%5BTXT%5D=HIGH&inputFieldValues%5B0%5D=' + gale_string.replace(' ', '+') + '&inputFieldNames%5B0%5D=TXT&operators%5B1%5D=And&inputFieldValues%5B1%5D=&inputFieldNames%5B1%5D=OQE&operators%5B2%5D=And&inputFieldValues%5B2%5D=&inputFieldNames%5B2%5D=OQE&_fuzzyEnabled=on&limiterFieldValues%5BDB%5D=GDSC&limiterFieldValues%5BDB%5D=BNCN&limiterFieldValues%5BDB%5D=DMHA&limiterFieldValues%5BDB%5D=ECCO&limiterFieldValues%5BDB%5D=FTHA&limiterFieldValues%5BDB%5D=NCCO&limiterFieldValues%5BDB%5D=NCNP&limiterFieldValues%5BDB%5D=NCUK&limiterFieldValues%5BDB%5D=PLEX&limiterFieldValues%5BDB%5D=BBCN&limiterFieldValues%5BDB%5D=NICN&limiterFieldValues%5BDB%5D=ECON&limiterFieldValues%5BDB%5D=ILN&limiterFieldValues%5BDB%5D=MOML&limiterFieldValues%5BDB%5D=MOME&limiterFieldValues%5BDB%5D=STHA&limiterFieldValues%5BDB%5D=TGRH&limiterFieldValues%5BDB%5D=TTDA&limiterFieldValues%5BDB%5D=TLSH&limiterFieldValues%5BDB%5D=USDD&limiterTypes%5BDB%5D=OR&dateIndices=DA&dateLimiterValues%5BDA%5D.dateMode=0&dateLimiterValues%5BDA%5D.fromDay=00&dateLimiterValues%5BDA%5D.fromMonth=00&dateLimiterValues%5BDA%5D.fromYear=&dateLimiterValues%5BDA%5D.toDay=00&dateLimiterValues%5BDA%5D.toMonth=00&dateLimiterValues%5BDA%5D.toYear=&standAloneLimiters=DA&_nonDatedLimiterValues%5BDA%5D=on&standAloneLimiters=DG&limiterTypes%5BDG%5D=OR&standAloneLimiters=TY&limiterTypes%5BTY%5D=OR&limiterFieldValues%5BPU%5D=&standAloneLimiters=PU&standAloneLimiters=GS&limiterTypes%5BGS%5D=OR&standAloneLimiters=PUB_COUNTRY&limiterTypes%5BPUB_COUNTRY%5D=OR&standAloneLimiters=PUB_STATE_COUNTRY&limiterTypes%5BPUB_STATE_COUNTRY%5D=OR&standAloneLimiters=PUB_CITY_STATE_COUNTRY&limiterTypes%5BPUB_CITY_STATE_COUNTRY%5D=OR&standAloneLimiters=LG&limiterTypes%5BLG%5D=OR&standAloneLimiters=IMG_TY&limiterTypes%5BIMG_TY%5D=OR&standAloneLimiters=SRC_INST&limiterTypes%5BSRC_INST%5D=OR&method=doSearch&noOfRows=3&searchType=AdvancedSearchForm&userGroupName=oxford&prodId=GDCS&nwf=y&searchResultsType=MultiTab';

    }
}

function nex() { // needs VPN connection
    //replace proximity in generic string
    
    nex_string = nex_string.replaceAll(regex, ' n' + prox + ' '); // double check this is the prox syntax for nex
    ...
    // update link out
    if (dateLower && dateUpper) {
        //change from google to nex
    // document.getElementById("nex_link").href = 'https://www.google.com/search?tbo=p&tbm=bks&q=' + nex_string.replace(' ', '+') + '&tbs=,cdr:1,cd_min:Jan+1_2+' + dateLower + ',cd_max:Dec+31_2+' + dateUpper + '&num=100';
    } else {
        // change from google to nex
        // document.getElementById("nex_link").href = 'https://www.google.com/search?tbo=p&tbm=bks&q=' + nex_string.replace(' ', '+') + '&num=100'
    }
}
...
function searchSelected() {
    ...
    var checkboxIDs = ['gb-checkbox', 'twi-checkbox', 'gale-checkbox', 'hathi-checkbox', 'jstor-checkbox']
    var locs = [document.getElementById("google_link").href, document.getElementById("twi_link").href, document.getElementById("gale_link").href, document.getElementById("hathi_link").href, document.getElementById("jstor_link").href]
